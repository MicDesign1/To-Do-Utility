...
// in simulator we redefine to format for todo Developer console
...
{\
	NSString * exceptionName = [@"org.todo." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.todo";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UItodoNativeItemNone = -1, 
	UItodoNativeItemSpinner = -2,
	UItodoNativeItemProgressBar = -3,
	
	UItodoNativeItemSlider = -4,
	UItodoNativeItemSwitch = -5,
	UItodoNativeItemMultiButton = -6,
	UItodoNativeItemSegmented = -7,
	
	UItodoNativeItemTextView = -8,
	UItodoNativeItemTextField = -9,
	UItodoNativeItemSearchBar = -10,
	
	UItodoNativeItemPicker = -11,
	UItodoNativeItemDatePicker = -12,
	
	UItodoNativeItemInfoLight = -13,
	UItodoNativeItemInfoDark = -14,
	
	UItodoNativeItemDisclosure = -15,
	
	UItodoNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all todo instances of
